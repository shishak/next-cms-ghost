...
export const ghostAPIUrl = process.env.CMS_GHOST_API_URL || 'http://18.193.174.227'
export const ghostAPIKey = process.env.CMS_GHOST_API_KEY || '16f3058a677627dcd3611c2698'

const siteUrl = process.env.SITE_URL || (process.env.VERCEL_URL && `https://${process.env.VERCEL_URL}`) || process.env.URL || 'https://nextghosts.netlify.app'
